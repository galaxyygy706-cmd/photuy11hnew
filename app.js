...
/* ---------------------------------------------------------------------
   2. Static data
   --------------------------------------------------------------------- */
const CATEGORIES = ["Tất cả", "Phở", "Món phụ", "Đồ uống", "Combo"];

const MENU_ITEMS = [
  {
    id: "pho-tai", name: "Phở Tái", category: "Phở", price: 50000,
    desc: "Nước dùng thanh ngọt, thịt bò tái thơm ngon", emoji: "🍜",
    customizable: true,
  ...
  {
    id: "pho-dac-biet", name: "Phở Đặc Biệt", category: "Phở", price: 80000,
    desc: "Tinh túy từ phần bò loại kỹ, hiếm và quý", emoji: "🍜",
    customizable: true,
    sizes: [{ label: "Thường", extra: 0 }, { label: "Lớn", extra: 15000 }],
    toppings: [
      { label: "Thêm thịt", extra: 20000 },
  ...
  {
    id: "pho-nam-gau", name: "Phở Nạm Gầu", category: "Phở", price: 65000,
    desc: "Nạm gầu mềm, béo ngậy, nước dùng đậm đà", emoji: "🍜",
    customizable: true,
    sizes: [{ label: "Thường", extra: 0 }, { label: "Lớn", extra: 15000 }],
    toppings: [
      { label: "Thêm thịt", extra: 20000 },
  ...
  { id: "trung-chan", name: "Trứng Chần", category: "Món phụ", price: 10000, desc: "Trứng gà tươi chần trong nước dùng thanh ngọt", emoji: "🥚" },
  { id: "trung-hap", name: "Trứng Hấp", category: "Món phụ", price: 20000, desc: "Trứng hấp mềm mịn, béo thơm cách thủy", emoji: "🍮" },
  { id: "quay", name: "Quẩy (4 cái)", category: "Món phụ", price: 10000, desc: "Giòn rụm, thơm ngon", emoji: "🥖" },
  ...
  { id: "combo-thuong-thuy", name: "Combo Thượng Thủy", category: "Combo", price: 89000, desc: "Phở đặc biệt + Quẩy + Trà đá", emoji: "🍱" },
];
...
function setTableStatus(tableId, status, extra = {}) {
  ...
  updateDoc(doc(db, "tables", tableId), { status, ...extra })
    .catch(() => showToast("Không thể cập nhật trạng thái bàn", true));
}
...
function renderTables() {
  ...
  return `
    <div class="scroll">
      ...
      <p class="hint-text">Chọn bàn để bắt đầu order</p>
    </div>`;
}
...
function renderMenu() {
  ...
  const filtered = MENU_ITEMS.filter((m) => {
    const matchCat = state.menuCategory === "Tất cả" || m.category === state.menuCategory;
    const matchQuery = m.name.toLowerCase().includes(state.menuQuery.toLowerCase());
  ...
  return `
    ...
    <div class="scroll">
      <p class="section-label">${state.menuCategory}</p>
